...
export type ToolAccept = "pdf" | "image" | "pdf-or-image";
...
export const PDF_TOOLS: PdfTool[] = [
  ...
  },
  {
    slug: "html-to-pdf",
    title: "HTML to PDF",
    description: "Turn webpages into PDF documents.",
    category: "convert",
    status: "soon",
    accept: "pdf",
    minFiles: 1,
  ...
  // Edit
  {
    slug: "edit-pdf",
    title: "Edit PDF",
    description: "Add text, images, shapes, and freehand annotations.",
    category: "edit",
    status: "soon",
    accept: "pdf",
    minFiles: 1,
  ...
  },
  {
    slug: "pdf-forms",
    title: "PDF Forms",
    description: "Create fillable forms or fill existing ones.",
    category: "edit",
    status: "soon",
    accept: "pdf",
    minFiles: 1,
  ...
  },
  {
    slug: "sign-pdf",
    title: "Sign PDF",
    description: "Add your e-signature or request signatures.",
    category: "security",
    status: "soon",
    accept: "pdf",
    minFiles: 1,
  ...
  },
  {
    slug: "translate-pdf",
    title: "Translate PDF",
    description: "Translate while keeping fonts and layout intact.",
    category: "security",
    status: "soon",
    accept: "pdf",
    minFiles: 1,
